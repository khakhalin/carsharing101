...
Before we dive into the depth of carsharing-related data science, we need to agree on some common terminology. I am not quite sure how standard this terminology is, for the business, but these are the terms consistently used in this document, both when discussing the simulations, and the real-world business that we are trying to simulate.

We will imagine cars as points, standing on a map, waiting to be rented and driven to some other point of the map. We won't concern ourselves with the route they take through the map once they are rented: we assume that cars are driven by people (that they are not yet automated), which makes their trajectories a private sensitive information. 
...
Demand is app openings or the platonic idea of the underlying force towards it
